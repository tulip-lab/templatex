%% 
%% ---------------------------------------------------------------
%% Copyright (C) 2012 Gang Li
%% ---------------------------------------------------------------
%%
%% This work is the default powerdot template file in TULIP Lab and may be
...
%%
%% {$HeadURL: http://xp-dev.com/svn/TULIP/presentation/pdotemplatex/trunk/powerdot-templatex.tex $}
%% {$LastChangedDate: 2012-11-02 16:19:18 +1100 (Fri, 02 Nov 2012) $}
...
lf=\href{http://www.tulip.org.au}{\copyright \emph{TULIP Lab} (G. Li)},
rf={Presentation Title},
}
