...
%% ---------------------------------------------------------------
%%
%% This work is the default powerdot-tulip test file and may be
...
%%
%% {$HeadURL: svn://cloud.tulip.org.au/WAEERepository/presentation/powerdot-tulip/trunk/powerdot-tulip.tex $}
%% {$LastChangedDate: 2015-12-02 18:35:25 +0800 (Wed, 02 Dec 2015) $}
