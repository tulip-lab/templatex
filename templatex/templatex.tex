...
\fancyhead[LO,RE]{\ensuremath{\Rightarrow}\textbf{\textbf{[CONFIDENTIAL]}}\ensuremath{\Leftarrow}}
\fancyhead[CO,CE]{}
%=================================================================
\fancyfoot{} % clear all footer fields
\fancyfoot[CE,CO]{\thepage}
\fancyfoot[LO,LE]{\includegraphics[height=.9\headheight]{figures/tulip-icon.png}V\gitVtagn-B\gitBranch}
\fancyfoot[RO,RE]{\gitCommitterName \ on: \gitCommitterDate }
...
\hypersetup
{
    ...
    pdftitle={TULIP Confidential Draft},
    pdfkeywords={TULIP, Draft, Data Science}
}
