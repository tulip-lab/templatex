...
\newcommand{\draftnote}[3]{\ifnum\DraftStatus=1
	\todo[author=#2,color=#1!40]{\textsf{#3}}	
    \fi}
% add yourself here:
\newcommand{\gangli}[1]{\draftnote{green}{GLi:}{#1}}
\newcommand{\qwu}[1]{\draftnote{purple}{QWu:}{#1}}
...
\usepackage[draft,colorinlistoftodos,color=blue!40]{todonotes}
...
\todo{add something here to test content.}

\HRule

\gangli{This is comment from Gang.}

Test citation~\cite{BJL11J01}
...
This is for~\cref{sec-conclusions}.\todo[inline]{testing testing}
