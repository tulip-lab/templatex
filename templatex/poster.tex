...
\author{Shaoni Wang$^1$, Haiyang Xia$^1$, Gang Li$^2$, Jianlong Tan$^3$}
...
\begin{center}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 10cm]{figures//GroupOutlyingMining.png}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 10cm]{figures//OutlyingAspMining.png}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 10cm]{figures//OutlierDetection.png}
...
\begin{center}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 8cm]{figures//frequency-distribution-feature1.png}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 8cm]{figures//frequency-distribution-feature2.png}
    ...
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 8cm]{figures//frequency-distribution-feature3.png}
...
\begin{tikzfigure}%[Overall architecture of \emph{GOAM} algorithm]
  \includegraphics[width=.9\linewidth]{figures//outlyingdegree.pdf}
\end{tikzfigure}
...
%    by pre-filtering highly scored subspaces
%    in each stage of candidate subspace construction.

%    However,
%    when the dimensionality of features are high,
%    the time complexity will be dramatically increased.
%    Here we adopt a stage-wise candidate subspace construction strategy to
%    alleviate the exponential explosion by pre-filtering highly scored subspaces
%    in each stage of candidate subspace construction.
  \end{description}
}
%%%%%%%%%% -------------------------------------------------------------------- %%%%%%%%%%
...
%    Utah Jazz               & \{Blk\}                   & \{3FA, 3PT\%\}                    \\
    ...
    \bottomrule
\end{tabular}
            %This is because the outlying aspects mining method can't obtain the features
            %  of a group and the scoring function is based on point to point metric.
            %  Therefore, it is not suitable for group outlying aspects mining.
\begin{minipage}{0.5\linewidth}
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 11cm]{figures//nor-1.pdf}
...
\begin{minipage}{0.5\linewidth}
    \centering
    \begin{tikzfigure}
    \includegraphics[height = 11cm]{figures//mil-1.pdf}
...
%    Most of existing works on outlying aspects mining pay attention to identifying
%  the outlying aspects of individual object rather than a group.
%  It lacks of methods that can effectively mine the outlying aspects of a particular group.
%  To fill this research gap,
%  this paper extends the traditional problem to the group level,
%  and formalizes the concept of group outlying aspect mining.
%  The \emph{Earth Move Distance} based on algorithm GOAM is proposed in
%  to automatically identify the outlying aspects of the query group.
%  The experiments demonstrated the effectiveness of the proposed
%  methods in mining these patterns.
\end{description}
}
%%%%%%%%%% -------------------------------------------------------------------- %%%%%%%%%%
...
\note[targetoffsetx=-13cm, targetoffsety=-9.9cm,rotate=0,angle=180,radius=8cm,width=.96\textwidth,innersep=.4cm]
{
\begin{minipage}{0.3\linewidth}
\centering
