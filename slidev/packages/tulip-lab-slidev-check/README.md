...
```sh
pnpm add -D tulip-lab-slidev-check@0.4.1
...
- Cover, TOC, Questions, and Contact structure;
- the Talk acknowledgement page immediately after the Cover and before the TOC;
