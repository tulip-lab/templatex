...
const publicPackages = new Map([
  ...
  ['packages/slidev-addon-tulip-lab-pages', { name: 'slidev-addon-tulip-lab-pages', version: '0.3.0' }],
  ['packages/slidev-theme-tulip-lab', { name: 'slidev-theme-tulip-lab', version: '0.3.0' }],
